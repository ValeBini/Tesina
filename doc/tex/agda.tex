...
Como se ve en el ejemplo, la manera de hacer una declaración inductiva-recursiva es mediante la palabra clave \AgdaKeyword{mutual}. Esta palabra clave puede utilizarse también para realizar definiciones mutuamente recursivas. 
